...
public class AccountDTO extends RepresentationModel<AccountDTO> {
    ...
    public AccountDTO(UUID id, String name, String role, String username, String password) {
        this.id = id;
        this.name = name;
        this.role = role;
    ...
    public AccountDTO(UUID id, String name, String role, String username, String password, Set<Device> devices) {
        this.id = id;
        this.name = name;
        this.role = role;
        this.username = username;
